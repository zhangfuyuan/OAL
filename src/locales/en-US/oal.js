export default {
  ...
  'oal.common.maxLength': `Enter a maximum of {num} words`,
  ...
  'oal.user-manage.currentToTotal': `There are {total} agent`,
  ...
  'oal.log.currentToTotal': `There are {total} people in total`,
  ...
  'oal.face.batchAddPersonnelPhotosDragtips1': `Staff photo (.jpg;.jpeg;.png)`,
  ...
  'oal.face-visitor.visitorStaffid': `Visitor staffid`,
  'oal.face-visitor.uploadExplainP1': `1- Size no more than 240kb, jpg, jpeg, png only supported`,
  'oal.face-visitor.uploadExplainP2': `2- The face should account for more than 1/3 of the photo area. It is recommended to use the id photo to avoid blurring, wearing sunglasses, excessive beauty and head rotation`,
  ...
  'oal.common.checkAll': `Check all`,
  'oal.settings.menu-alarm': `Alarm set`,
  'oal.settings.sendSettings': `Send settings`,
  'oal.settings.receiveSettings': `Receive settings`,
  'oal.settings.alarmEvents': `Alarm events`,
  'oal.settings.alarmContent': `Alarm content`,
  'oal.common.complete': `Complete`,
  'oal.settings.sendMail': `The email address for send`,
  ...
  'oal.settings.receiveMail': `The email address for receipt`,
  'oal.settings.temperatureAnomalies': `Temperature anomalies`,
  'oal.settings.notWearMask': `No mask (Mask mode)`,
  'oal.settings.mailSubject': `Mail subject`,
  'oal.settings.mailContent': `Mail content`,
  ...
  'oal.settings.defaultTemplate': `Use default template`,
  'oal.settings.clickCopyEventVariable': `Click to copy the event variable`,
  'oal.settings.nickname': `Nickname`,
  'oal.settings.devicename': `Devicename`,
  ...
  'oal.settings.pleaseLater': `Please later`,
  'oal.settings.testingAuthorizationEnvironment': `Authorization environment being tested...`,
  ...
  'oal.device.openWhenVerifySuccessfully': `Open when verify successfully`,
  'oal.device.openWhenVerifyFailed': `Open when verify failed`,
  'oal.device.faceAndTemperature': `Face + Temperature`,
  'oal.device.maskAndTtemperature': `Mask + Temperature`,
  'oal.device.temperature': `Temperature`,
