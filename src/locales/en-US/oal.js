export default {
  ...
  'oal.face.deleteGroupConfirm': 'Group deletion is not recoverable, users in the group will belong to the superior group, delete or not?',
  ...
  'oal.face.userPhotos': 'User photos',
  'oal.face.uploadFile': 'Upload file',
  'oal.face.uploadExplain': 'Explain',
  'oal.face.uploadExplainP1': '1. Only support the extension of PNG, JPG format of user pictures;',
  'oal.face.uploadExplainP2': '2. The size of the picture shall not exceed 500KB;',
  'oal.face.uploadExplainP3': '3. In order to ensure the user recognition effect, the user should be clear and receive light evenly.',
  'oal.face.enterUserPhotosTips': 'Please upload a face photo',
  'oal.face.uploadImageSizeLimit': 'The image size should not exceed 500KB',
  'oal.face.uploadImageFormatLimit': 'Only PNG and JPG image files are supported',
