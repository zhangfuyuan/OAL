export default {
  ...
  'user-login.register-result.activation-email': `The activation email has been sent to your email address and is valid for 24 hours. Please log in to the email in time and click on the link in the email to activate the account.`,
  ...
  'user-login.client.placeholder': `Please describe your customer service, internal customers directly @ Name / job number`,
